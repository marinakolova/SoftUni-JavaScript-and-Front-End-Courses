function solve() {
    const getInputField = (n) => document.querySelector(`#container > input[type=text]:nth-child(${n})`);
    ...
    const checkValidInput = (arr, num) => arr.every(x => x !== "") && !isNaN(Number(num));
            ...
            const buttons = {
                ...
                Archive: e => {
                    ...
                    if (checkValidInput([ticketsSold], ticketsSold)) {
                        ...
                        html.archivesList.appendChild(archivedTemplate(name, ticketsSold * Number(price)));
                        parent.remove();
                    }
                },
